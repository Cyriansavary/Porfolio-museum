...
function createDrivingSimZone(scene: BABYLON.Scene, project: ProjectData) {
  ...
  addVerticalDashes("sectorA", 0, -35.2, -27.4, 3.1, 1.2);
  addVerticalDashes("sectorB", 13.8, -10.8, 8.8, 3.2, 1.06);
  addVerticalDashes("sectorC", -13.8, 1.2, 15.8, 3.2, 1.04);
  addHorizontalDashes("sectorD", 15.8, 3.2, 14.8, 3.2, 1.14);
  addHorizontalDashes("sectorE", -6.2, -4.8, 2.8, 3.1, 1.08);
  addHorizontalDashes("sectorF", -20.2, 1.2, 11.8, 3.1, 1.08);
